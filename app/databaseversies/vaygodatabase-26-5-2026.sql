...
--
-- Host: db
-- Gegenereerd op: 26 mei 2026 om 11:48
-- Serverversie: 8.4.8
-- PHP-versie: 8.3.30
...
(2, 'Ibiza', 'Spanje', 'Ibiza is een gebied in Spanje', 240, 'Spanje.png', 'Europa', 1, 0, 0, 0, 0, 'Welkom in Ibiza!', 'historie', 'wat te doen', 'ibiza.png', ''),
(3, 'Lissabon', 'Portugal', 'Lissabon is een stad in Portugal', 345, 'Portugal.png', 'Europa', 1, 1, 0, 0, 0, 'Welkom in Lissabon!', 'historie', 'wat te doen', 'lissabon.png', ''),
(4, 'Tokyo', 'Japan', 'Tokyo is een stad in japan', 1100, 'Japan.png', 'Azië', 0, 1, 0, 0, 0, 'Welkom in Tokyo', 'historie', 'wat te doen', 'Tokyo.png', '');
...
--
ALTER TABLE `Gebruikers`
  MODIFY `User-id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

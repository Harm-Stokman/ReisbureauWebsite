...
--
-- Host: db
-- Gegenereerd op: 22 jun 2026 om 14:36
-- Serverversie: 8.4.8
-- PHP-versie: 8.3.30
...
(13, 12, 2, 4, '2026-07-29', '2026-08-12');
...
(2, 'Erik Bakker', 'ebakker@gmail.com', 'bakker'),
(3, 'harm-stokman', 'harmstok2006@gmail.com', 'harm'),
...
INSERT INTO `recensies` (`Recensie_id`, `User_id`, `Reis_id`, `Bericht`, `Beoordeling`) VALUES
(1, 3, 1, 'Het was een oke reis.', 3),
(3, 3, 2, 'De reis naar Ibiza was goed.', 4),
(5, 2, 10, 'Het was een hele leuke reis naar Caïro!', 4),
(6, 2, 5, 'De reis naar Miami was bijzonder matig', 2);
...
CREATE TABLE `Reizen` (
  ...
  `Prijs` int NOT NULL,
  `Vlag` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  `kaart_afbeelding` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Gegevens worden geëxporteerd voor tabel `Wachtwoord_vergeten`
--

INSERT INTO `Wachtwoord_vergeten` (`id`, `UID`, `expiration`, `Emailadres`) VALUES
(123, '6a33d60c073b6', '2026-06-19', 'harmstok2006@gmail.com');
...
--
ALTER TABLE `Bestellingen`
  MODIFY `Bestelling_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT voor een tabel `Boekingen`
--
ALTER TABLE `Boekingen`
  MODIFY `Boeking_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `recensies`
  MODIFY `Recensie_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT voor een tabel `Reizen`
--
ALTER TABLE `Reizen`
  MODIFY `Reis_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
